...
$('ol').append('<li>Puppies are FOREVER!</li>');

// 6. Scratch that; the list is silly. Empty the aside and 
//    put a paragraph in it apologizing for the list’s existence.

$('aside').html($('<p>', {text: 'We sincerely aplogize for the previous list. We have removed this mistake and are under constrution for new content.'}));
